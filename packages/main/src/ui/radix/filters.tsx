  ...
  return (
    <InputGroup
      className={cn(
        ...
        context.size === "default" &&
          "style-lyra:h-8! style-maia:h-9! style-mira:h-7! style-nova:h-8! style-vega:h-9!",
        context.size === "lg" &&
    ...
    >
      ...
      <InputGroupInput
        ...
        className={cn(
          context.size === "sm" &&
            "style-lyra:h-7! style-maia:h-8! style-mira:h-6! style-nova:h-7! style-vega:h-8! text-xs",
          context.size === "default" &&
            "style-lyra:h-8! style-maia:h-9! style-mira:h-7! style-nova:h-8! style-vega:h-9!",
          context.size === "lg" &&
            "style-lyra:h-9! style-maia:h-10! style-mira:h-8! style-nova:h-9! style-vega:h-10!",
...
function FilterValueSelector<T = unknown>({
  ...
  if (field.customRenderer) {
    return (
      <ButtonGroupText className="whitespace-nowrap style-lyra:bg-background style-mira:bg-background style-nova:bg-background style-vega:bg-background text-start outline-hidden hover:bg-accent aria-expanded:bg-accent style-lyra:dark:bg-input/30 style-mira:dark:bg-input/30 style-nova:dark:bg-input/30 style-vega:dark:bg-input/30">
    ...
    >
      <div className={cn(filtersContainerVariants({ variant, size }), className)}>
        ...
        {filters.map((filter) => {
          ...
          return (
            <ButtonGroup key={filter.id}>
              <ButtonGroupText className="style-lyra:bg-background style-mira:bg-background style-nova:bg-background style-vega:bg-background style-lyra:dark:bg-input/30 style-mira:dark:bg-input/30 style-nova:dark:bg-input/30 style-vega:dark:bg-input/30">
                {field.icon && field.icon}
                {field.label}
              </ButtonGroupText>
              <FilterOperatorDropdown<T>
