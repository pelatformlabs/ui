    ...
    <div ref={containerRef} className="relative">
      ...
      >
        <ScrollAreaPrimitive.Viewport
          ...
          className="size-full style-lyra:rounded-none style-maia:rounded-2xl style-mira:rounded-lg style-nova:rounded-lg style-vega:rounded-lg outline-none transition-[color,box-shadow] focus-visible:outline-1 focus-visible:ring-[3px] focus-visible:ring-ring/50"
        >
        ...
        {showHorizontal && (
          <ScrollAreaPrimitive.ScrollAreaScrollbar
            ...
            className="flex touch-none select-none p-px transition-colors data-[orientation=horizontal]:h-2.5 data-[orientation=vertical]:h-full data-[orientation=vertical]:w-2.5 data-[orientation=horizontal]:flex-col data-[orientation=vertical]:border-s data-[orientation=vertical]:border-s-transparent data-[orientation=horizontal]:border-t data-[orientation=horizontal]:border-t-transparent"
          >
            <ScrollAreaPrimitive.ScrollAreaThumb
              data-slot="data-grid-thumb"
              className="relative flex-1 style-lyra:rounded-none style-maia:rounded-full style-mira:rounded-full style-nova:rounded-full style-vega:rounded-full bg-border"
            />
          </ScrollAreaPrimitive.ScrollAreaScrollbar>
        )}
