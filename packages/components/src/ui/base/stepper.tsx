  ...
  return (
    <button
      ...
      className={cn(
        ...
        "style-lyra:gap-2.5 style-maia:gap-3 style-mira:gap-2 style-nova:gap-2.5 style-vega:gap-3 style-lyra:rounded-none style-maia:rounded-full style-mira:rounded-full style-nova:rounded-full style-vega:rounded-full",
        className,
      )}
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "style-lyra:rounded-none style-maia:rounded-full style-mira:rounded-sm style-nova:rounded-full style-vega:rounded-full style-lyra:text-[0.625rem] style-maia:text-xs style-mira:text-[0.625rem] style-nova:text-xs style-vega:text-xs",
        className,
      )}
    >
...
function StepperTitle({ children, className }: React.ComponentProps<"h3">) {
  ...
  return (
    <h3
      ...
      data-state={state}
      className={cn(
        "font-medium style-lyra:text-xs style-maia:text-sm style-mira:text-xs style-nova:text-sm style-vega:text-sm leading-none",
        className,
      )}
    >
      {children}
...
function StepperDescription({ children, className }: React.ComponentProps<"div">) {
  ...
  return (
    <div
      ...
      data-state={state}
      className={cn(
        "style-lyra:text-xs style-maia:text-sm style-mira:text-xs/relaxed style-nova:text-sm style-vega:text-sm text-muted-foreground",
        className,
      )}
    >
      {children}
